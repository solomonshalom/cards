  ...
  return (
    <>
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        >
          Analayze Factuality With 
          <br />
          <span className="bg-gradient-to-r from-blue-500 via-green-600 to-indigo-500 bg-clip-text text-transparent">
            Intelligence
          </span>
        </h1>
        <p
        ...
        >
          Cards analyzes real-time speech & text to find out it's factuality, with citations!
        </p>
        <div
